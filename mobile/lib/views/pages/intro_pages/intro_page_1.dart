    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          SizedBox(height: 8.0),
          Text(
            "Your AI-powered plant health companion. Let's set up your profile to provide personalized plant care advice.", textAlign: TextAlign.center,
          ...
          CustomContainerWidget(
            ...
            child: Column(
              ...
              children: [
                Text("What's your phone number?", style: AppTheme.labelMedium.copyWith(color: AppTheme.white),), 
                TextField(),
                ],
            ),
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text(
                'Continue with',
                style: AppTheme.labelMedium.copyWith(color: AppTheme.lightGreen1),
              ),
              SizedBox(width: 5),
              Expanded(child: Divider(thickness: 1.0)),
            ],
          ...
          OnboardingButtonWidget(
            onTap: () {},
            imageString: 'assets/images/facebook-svgrepo-com.svg',
